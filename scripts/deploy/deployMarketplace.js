...
async function main() {
    ...
    const market = await BeanieMarketV11.deploy(addressesMoonriver.WETH, feeProcessor.address);
    ...
    const fungibleMarket = await FungibleBeanieMarketV1.deploy(addressesMoonriver.WETH, feeProcessor.address);
